                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-group mb-1">
                            <div class="card card-inverse card-primary" style="width:40%">
                                <div class="card-header font-weight-bold">Pageviews</div>
                                <div class="card-block py-1 pb-0">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header card-header-inverse card-header-primary">
                                <div class="font-weight-bold mb-1">Revenue</div>
                                <div class="chart-wrapper mb-1" style="height:220px;">
